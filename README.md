...
# .NET Web API with Postgres

> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-dotnet-api-postgres)

- HTTP API built with [ASP.NET Core](https://dotnet.microsoft.com/apps/aspnet) (.NET 9).
- Runs in a Docker [web service](https://docs.stacktape.com/compute-resources/web-services/) with a Postgres
  [relational database](https://docs.stacktape.com/resources/relational-databases/). Uses Entity Framework Core for
  database access.
...
```bash
stacktape init --starterId dotnet-api-postgres
```
